...
import com.example.aspect.domain.ExceptionLog;
import com.example.aspect.domain.OperationLog;
...
public class OperLogAspect {
    ...
    public static final Logger logger = LoggerFactory.getLogger(OperLogAspect.class);
     ...
     */
    @Pointcut("@annotation(com.example.aspect.log.OperLog)")
     ...
     */
    @Pointcut("execution(* com.example.psm..*.*(..))")
...
//            operlog.setOperUserName(UserShiroUtil.getCurrentUserName()); // 请求用户名称
            operlog.setOperIp(IPUtil.getRemoteHost(request)); // 请求IP
            operlog.setOperUri(request.getRequestURI()); // 请求URI
            operlog.setOperCreateTime(new Date()); // 创建时间
            operlog.setOperVer(operVer); // 操作版本
            System.out.println("--------------saveOperLog----------------");
            logger.info("输出的结果是{}",operlog);
...
//            excepLog.setOperUserName(UserShiroUtil.getCurrentUserName()); // 操作员名称
            ...
            excepLog.setOperIp(IPUtil.getRemoteHost(request)); // 操作员IP
            excepLog.setOperVer(operVer); // 操作版本号
            excepLog.setOperCreateTime(new Date()); // 发生异常时间

            System.out.println("--------------saveExceptionLog----------------");
            logger.info("出现异常时 {}",excepLog);
